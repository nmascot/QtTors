...
\li{evaluate Hecke character \var{chi} at ideal \var{id}}{chareval$(\var{gc},\var{chi},\var{id})$}
...
\li{$\chi$ s.t. $\chi_{v} \approx \var{Lchiv}\kbd{[i]}$ for~$v=\var{Lv}\kbd{[i]}$}{gcharidentify$(\var{gc},\var{Lv},\var{Lchiv})$}
\li{basis of group of algebraic characters}{gcharalgebraic$(gc)$}
