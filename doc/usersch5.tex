...
\fun{GEN}{Flx_mul_pre}{GEN x, GEN y, ulong p, ulong pi}. We assume \var{pi} is
...
\fun{GEN}{Flx_sqr_pre}{GEN x, ulong p, ulong pi}. We assume \var{pi} is the
pseudoinverse of $p$, or $0$ in which case we assume \kbd{SMALL\_ULONG}$(p)$.

\fun{GEN}{Flx_powu}{GEN x, ulong n, ulong p} return $x^n$.

\fun{GEN}{Flx_powu_pre}{GEN x, ulong n, ulong p, ulong pi} as
\kbd{Flx\_powu}. We assume \var{pi} is the pseudoinverse of $p$, or $0$ in
...
here $p$ must be prime. We assume \var{pi} is the pseudoinverse of $p$, or
...
as \kbd{Flx\_Frobenius}. We assume \var{pi} is the pseudoinverse of $p$, or
$0$ in which case we assume \kbd{SMALL\_ULONG}$(p)$.
...
\var{pi} is the pseudoinverse of $p$, or $0$ in which case we assume
\kbd{SMALL\_ULONG}$(p)$.
...
assume \var{pi} is the pseudoinverse of $p$, or $0$ in which case we assume
\kbd{SMALL\_ULONG}$(p)$.
...
as \kbd{Flx\_extgcd}. We assume \var{pi} is the pseudoinverse of $p$, or $0$
...
\kbd{Flx\_oneroot\_split}. We assume \var{pi} is the pseudoinverse of $p$, or
$0$ in which case we assume \kbd{SMALL\_ULONG}$(p)$.
...
\kbd{Flx\_eval}. We assume \var{pi} is the pseudoinverse of $p$,
...
\kbd{Flx} $P$, return $P(a)$. We assume \var{pi} is the pseudoinverse of $p$,
or $0$ in which case we assume \kbd{SMALL\_ULONG}$(p)$.
...
as \kbd{Flx\_Flxq\_eval}, where \var{pi} is a pseudoinverse of $p$,
or $0$ in which case we assume \kbd{SMALL\_ULONG}$(p)$.
...
see \kbd{FlX\_FlxqV\_eval}. We assume \var{pi} is a pseudoinverse of $p$, or
$0$ in which case we assume \kbd{SMALL\_ULONG}$(p)$.
...
as \kbd{FlxC\_Flxq\_eval}. We assume \var{pi} is a pseudoinverse of $p$, or
$0$ in which case we assume \kbd{SMALL\_ULONG}$(p)$.
...
as \kbd{FlxC\_FlxqV\_eval} where \var{pi} is a pseudoinverse of $p$,
or $0$ in which case we assume \kbd{SMALL\_ULONG}$(p)$.
